...
func TestMobile_AddData(t *testing.T) {
	...
	res4, err := testVars.mobile1.FileData(list.Items[0].Files[0].File.Hash)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMobile_FileData(t *testing.T) {
	res, err := testVars.mobile1.FileData(testVars.files[0].Files[0].Links["small"].Hash)
	if err != nil {
...
func TestMobile_ImageFileDataForMinWidth(t *testing.T) {
	large, err := testVars.mobile1.FileData(testVars.files[0].Files[0].Links["large"].Hash)
	if err != nil {
		t.Fatal(err)
	}
	small, err := testVars.mobile1.FileData(testVars.files[0].Files[0].Links["small"].Hash)
	if err != nil {
		t.Fatal(err)
	}
	thumb, err := testVars.mobile1.FileData(testVars.files[0].Files[0].Links["thumb"].Hash)
	if err != nil {
		t.Fatal(err)
	}
	...
	d1, err := testVars.mobile1.ImageFileDataForMinWidth(pth, 2000)
	if err != nil {
		t.Fatal(err)
	}
	if d1 != large {
	...
	d2, err := testVars.mobile1.ImageFileDataForMinWidth(pth, 600)
	if err != nil {
		t.Fatal(err)
	}
	if d2 != large {
	...
	d3, err := testVars.mobile1.ImageFileDataForMinWidth(pth, 320)
	if err != nil {
		t.Fatal(err)
	}
	if d3 != small {
	...
	d4, err := testVars.mobile1.ImageFileDataForMinWidth(pth, 80)
	if err != nil {
		t.Fatal(err)
	}
	if d4 != thumb {
